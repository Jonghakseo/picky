...
private enum PickyLegacyWorkspaceDefaults {
    static let knownGeneratedAgentsMarkdownData: Set<Data> = [
        Data(
            """
...
enum PickyWorkspaceSeeder {
    ...
    private static func migrateLegacyGeneratedAgentsMarkdown(
        ...
        guard fileManager.fileExists(atPath: agentsURL.path),
              ...
              PickyLegacyWorkspaceDefaults.knownGeneratedAgentsMarkdownData.contains(existing)
        else { return }
