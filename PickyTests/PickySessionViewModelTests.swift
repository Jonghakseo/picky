...
struct PickySessionViewModelTests {
    ...
    @Test func hudDockKeyboardShortcutsOpenNumberedSessionsAndCycle() throws {
        ...
        #expect(PickyHUDKeyboardShortcutPolicy.shouldPassThroughToFocusedTerminal(modifiers: []) == true)
        #expect(PickyHUDKeyboardShortcutPolicy.shouldPassThroughToFocusedTerminal(modifiers: .control) == true)
        #expect(PickyHUDKeyboardShortcutPolicy.shouldPassThroughToFocusedTerminal(modifiers: [.control, .shift]) == true)
        #expect(PickyHUDKeyboardShortcutPolicy.shouldPassThroughToFocusedTerminal(modifiers: .option) == true)
        #expect(PickyHUDKeyboardShortcutPolicy.shouldPassThroughToFocusedTerminal(modifiers: .command) == false)
        #expect(PickyHUDKeyboardShortcutPolicy.shouldPassThroughToFocusedTerminal(modifiers: [.command, .shift]) == false)
