...
const CONNECTION_INFO_FILE_NAME = "agentd-connection.json";

const PickyAgentdConnectionInfoSchema = z.object({
...
type PickyAgentdConnectionInfo = z.infer<typeof PickyAgentdConnectionInfoSchema>;
