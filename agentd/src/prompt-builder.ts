...
export function buildMainAgentPrompt(context: PickyContextPacket): BuiltPrompt {
  const lines = [
    ...
    "- If the request needs long-running work, detailed screen analysis, code/repo/file tools, web/video extraction, MCPs, or multiple turns, call the `picky_handoff` tool with clear instructions for a side Pi agent.",
