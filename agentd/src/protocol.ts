...
export const PickySessionDiffViewSchema = z.enum(["unstaged", "staged"]);
export type PickySessionDiffView = z.infer<typeof PickySessionDiffViewSchema>;
export const PickySessionDiffFileSchema = z.object({
  path: z.string(),
...
export const CommandEnvelopeSchema = z.discriminatedUnion("type", [
  ...
  // Legacy senders supply only sessionId/prompt/cwd. New durable child
  // completions add the optional envelope fields below during this epoch.
  CommandBaseSchema.extend({
    type: z.literal("notifyMainOfPickleCompletion"),
...
export const EventEnvelopeVariantSchema = z.discriminatedUnion("type", [
  ...
  EventBaseSchema.extend({
    type: z.literal("sessionDiffResult"),
    sessionId: z.string(),
