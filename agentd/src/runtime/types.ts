...
export type RuntimeEvent =
  ...
  | { type: "tool"; toolCallId: string; name: string; status: "running" | "succeeded" | "failed"; preview?: string; argsPreview?: string; resultPreview?: string; resultJSONPreview?: string; resultPreviewTruncated?: boolean; resultPreviewRepaired?: boolean; subagentSummary?: PickySubagentToolSummary; filePath?: string; fileExistedBefore?: boolean }
