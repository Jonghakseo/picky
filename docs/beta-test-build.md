...
| `PICKY_DEVELOPMENT_TEAM` | Apple Developer Team ID, for example `TEAMID`. |
| `PICKY_SLACK_BOT_TOKEN` | Slack Bot User OAuth Token used by release notifications and in-app feedback. |
...
Expected local identity format for the current beta flow:
