...
References: [Picky principles](../design/PRINCIPLES.md), [tokens](../design/TOKENS.md), [Apple accessibility](https://developer.apple.com/design/human-interface-guidelines/accessibility), [Apple layout](https://developer.apple.com/design/human-interface-guidelines/layout).
...
- Settings: Hub rows and headings reflow with consistent card spacing. Shared Companion/HUD source files are unchanged.
...
- Final production gallery succeeded: 27 standard page/dialog scenes, four full settings scenes, fourteen full/enlarged page scenes, two expanded-disclosure renders, and two populated guide-card renders.
...
- Design-guide validation, token lint, and diff checks passed. Source review found no changes to non-Hub production files and no changed command/draft ownership. The app was not restarted.
